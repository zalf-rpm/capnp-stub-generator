...
class TestAbsolutePaths:
    ...
    def test_absolute_import_path(self, temp_schema_dir, temp_output_dir):
        ...
        args = [
            "-p", str(temp_schema_dir / "base.capnp"),
                 str(temp_schema_dir / "user.capnp"),
            "-o", str(temp_output_dir),
            "-I", str(temp_schema_dir.absolute())
        ]
...
class TestExcludePatterns:
    ...
    def test_exclude_multiple_files(self, temp_schema_dir, temp_output_dir):
        ...
        args = [
            ...
            "-o", str(temp_output_dir),
            "-r",
            "-e", str(temp_schema_dir / "test.capnp"),
    ...
    def test_exclude_with_recursive(self, temp_schema_dir, temp_output_dir):
        ...
        args = [
            ...
            "-o", str(temp_output_dir),
            "-r",
            "-e", str(temp_schema_dir / "subdir" / "nested.capnp")
        ]
...
""")
        ...
        args = [
            "-p", str(temp_schema_dir / "test.capnp"),
            "-o", str(temp_output_dir),
            "-I", str(temp_schema_dir), str(extra_dir)
        ]
...
class TestErrorHandling:
    ...
    def test_nonexistent_schema_file(self, temp_output_dir):
        ...
        args = [
            "-p", "/nonexistent/path/to/schema.capnp",
            "-o", str(temp_output_dir)
        ]
...
class TestRealWorldScenarios:
    ...
    def test_generate_from_existing_schemas(self, temp_output_dir):
        ...
        args = [
            "-p", str(SCHEMAS_DIR / "primitives.capnp"),
            "-o", str(temp_output_dir)
        ]
    ...
    def test_batch_generation_with_imports(self, temp_output_dir):
        ...
        schemas = [
            SCHEMAS_DIR / "import_base.capnp",
            SCHEMAS_DIR / "import_user.capnp"
        ]
        ...
        args = [
            "-p"
        ] + [str(s) for s in existing_schemas] + [
            "-o", str(temp_output_dir),
            "-I", str(SCHEMAS_DIR)
        ]
...
class TestCLIInvocation:
    ...
    def test_cli_via_subprocess(self, temp_schema_dir, temp_output_dir):
        ...
        result = subprocess.run(
            ...
            capture_output=True,
            text=True,
            cwd=str(temp_schema_dir.parent)
        )
