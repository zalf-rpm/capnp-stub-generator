...
class TestDummyEnumsAndTypes:
    ...
    def test_enum_definition_and_imports(self, dummy_stub_lines) -> None:
    ...
    def test_testalltypes_field_presence_and_collections_import(self, dummy_stub_lines) -> None:
        lines = dummy_stub_lines
...
class TestDummyListsAndDefaults:
    ...
    def test_lists_small_struct_and_listlist_fields(self, dummy_stub_lines) -> None:
        lines = dummy_stub_lines
    ...
    def test_list_defaults_struct_and_scalar_lists_present(self, dummy_stub_lines) -> None:
        lines = dummy_stub_lines
    ...
    def test_field_zero_bit_and_defaults(self, dummy_stub_lines) -> None:
        lines = dummy_stub_lines
...
class TestDummyGroupsAndNested:
    ...
    def test_group_field_members_materialized(self, dummy_stub_lines) -> None:
        lines = dummy_stub_lines
    ...
    def test_nested_types_enums_and_lists(self, dummy_stub_lines) -> None:
        lines = dummy_stub_lines
    ...
    def test_using_type_aliases_resolved(self, dummy_stub_lines) -> None:
        lines = dummy_stub_lines
...
class TestDummyUnions:
    ...
    def test_union_which_methods_and_literal_import(self, dummy_stub_lines) -> None:
        lines = dummy_stub_lines
    ...
    def test_unnamed_union_fields_present(self, dummy_stub_lines) -> None:
        lines = dummy_stub_lines
    ...
    def test_interleaved_union_discriminants_sorted(self, dummy_stub_lines) -> None:
        lines = dummy_stub_lines
        which_methods = [line for line in lines if "def which" in line and "Literal" in line]
        assert which_methods

    def test_union_defaults_struct_initializers_present(self, dummy_stub_lines) -> None:
        lines = dummy_stub_lines
...
class TestDummyConstantsAndVersioning:
    ...
    def test_global_constants_and_derived_constant_present(self, dummy_stub_lines) -> None:
        lines = dummy_stub_lines
    ...
    def test_struct_constants_section(self, dummy_stub_lines) -> None:
        lines = dummy_stub_lines
        assert any("class _TestConstantsStructModule(_StructModule):" in line for line in lines)

    def test_versioned_structs_fields_and_defaults(self, dummy_stub_lines) -> None:
        lines = dummy_stub_lines
    ...
    def test_name_annotations_renamed_struct_enum_fields(self, dummy_stub_lines) -> None:
        lines = dummy_stub_lines
    ...
    def test_empty_struct_representation(self, dummy_stub_lines) -> None:
        lines = dummy_stub_lines
